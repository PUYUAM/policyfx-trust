#!/usr/bin/env python3
# alerts/fx-red-alert-telegram.py - Fire Telegram alert when USD/CNY breaches 7.35
...
try:
    ...
    if rate > ALERT_THRESHOLD:
        ...
        if res.status_code == 200:
            log_msg = f"[OK] {now} | {rate:.3f} > {ALERT_THRESHOLD} → Telegram alert sent"
        else:
